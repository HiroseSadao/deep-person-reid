...
from new_torchreid.engine.image import ImageTripletEngine
...
class VideoTripletEngine(ImageTripletEngine):
    ...
    Args:
        datamanager (DataManager): an instance of ``new_torchreid.data.ImageDataManager``
            or ``new_torchreid.data.VideoDataManager``.
    ...
    Examples::
        ...
        datamanager = new_torchreid.data.VideoDataManager(
